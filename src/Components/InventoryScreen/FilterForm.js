...
function FilterForm({setCategoryFilter}) {
    ...
    return (
        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div className="sm:col-span-2">
                <label htmlFor="title" className="block text-sm/6 font-medium text-white">Title (contains)</label>
                <div className="mt-2">
            ...
            <div className="sm:col-span-2">
                <label htmlFor="author" className="block text-sm/6 font-medium text-white">Author (contains)</label>
                <div className="mt-2">
            ...
            <div className="sm:col-span-2">
                <label htmlFor="category" className="block text-sm/6 font-medium text-white">Category</label>
